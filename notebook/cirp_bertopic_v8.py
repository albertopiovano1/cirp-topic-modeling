...
"""
================================================================================
CIRP BIBLIOMETRIC ANALYSIS - BERTopic Pipeline v6.4 (natural, improved)
================================================================================
...
class Config:
    ...
    CACHE_TAG: str = "v6_4"   # bump this if you change preprocessing in a way that invalidates cached embeddings
...
def build_model(encoder: SentenceTransformer) -> BERTopic:
    print("\n" + "=" * 80)
...
def write_final_report(results_dir: Path, figures_dir: Path, n_docs: int, n_topics: int, n_out: int, metrics: Dict[str, float]) -> None:
    ...
    with out.open("w", encoding="utf-8") as f:
        ...
        f.write("Pipeline Version: v6.4 (natural, improved)\n")
...
def main():
    print("\n" + "=" * 80)
    print("CIRP BIBLIOMETRIC ANALYSIS - BERTopic Pipeline v6.4")
    print("=" * 80)
    ...
    # Model
    model = build_model(emb_gen.encoder)
